...
# DVE full session
# Saved on Fri Mar 1 19:03:00 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{61 58} {1980 921}}
...
gui_sg_addsignal -group "$_session_group_1" { riscv_sim.proc.ctrl.inst_is_muldiv_Dhl }
