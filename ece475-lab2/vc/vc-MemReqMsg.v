...
//  +------+-----------+------+-----------+
//
// The message t is parameterized by the number of bits in the address
...
#(
  ...
  input [`VC_MEM_REQ_MSG_TYPE_SZ(p_addr_sz,p_data_sz)-1:0] t,
  ...
  assign bits[`VC_MEM_REQ_MSG_TYPE_FIELD(p_addr_sz,p_data_sz)] = t;
...
#(
  ...
  output [`VC_MEM_REQ_MSG_TYPE_SZ(p_addr_sz,p_data_sz)-1:0] t,
  ...
  assign t = bits[`VC_MEM_REQ_MSG_TYPE_FIELD(p_addr_sz,p_data_sz)];
...
#(
  ...
  wire [`VC_MEM_REQ_MSG_TYPE_SZ(p_addr_sz,p_data_sz)-1:0] t;
