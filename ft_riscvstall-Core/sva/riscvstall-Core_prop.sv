...
// Assumptions
// Assume valid opcode
as_val_instr: assume property (type_alu_r_instr || type_alu_i_instr);
...
as_rs1_match: assert property ((type_alu_r_instr || type_alu_i_instr) && ctrl.inst_val_Dhl |-> (rs1 == dpath.rf_raddr0_Dhl)); 
