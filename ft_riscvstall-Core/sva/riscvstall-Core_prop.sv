// This property file was autogenerated by AutoSVA on 2024-04-29
...
wire load_dmem_rf_trans_transid_response = load_rf_hsk && (load_rf_transid == symb_load_dmem_out_transid) && (symb_load_dmem_out_transid != 8'b0);
...
as__load_dmem_rf_trans_transid_eventual_response: assert property (|load_dmem_rf_trans_transid_sampled && (symb_load_dmem_out_transid != 8'b0) |-> s_eventually(load_rf_val && (load_rf_transid == symb_load_dmem_out_transid) ));
...
as__load_dmem_rf_trans_transid_data_unique: assert property (|load_dmem_rf_trans_transid_sampled && (symb_load_dmem_out_transid != 8'b0) |-> !load_dmem_rf_trans_transid_set);
...
// Assert that every request has a response and that every reponse has a request
as__ir_rf_trans_transid_eventual_response: assert property (|ir_rf_trans_transid_sampled && (symb_ir_transid != 8'b0)|-> s_eventually(rf_val && (rf_transid == symb_ir_transid) ));
...
as__ir_rf_trans_transid_data_unique: assert property (|ir_rf_trans_transid_sampled && (symb_ir_transid != 8'b0)|-> !ir_rf_trans_transid_set);
...
// Assert that every request has a response and that every reponse has a request
as__load_ir_dmem_trans_transid_eventual_response: assert property (|load_ir_dmem_trans_transid_sampled  && (symb_load_ir_transid != 8'b0) |-> s_eventually(load_dmem_val && (load_dmem_transid == symb_load_ir_transid) ));
...
as__load_ir_dmem_trans_transid_data_unique: assert property (|load_ir_dmem_trans_transid_sampled && (symb_load_ir_transid != 8'b0) |-> !load_ir_dmem_trans_transid_set);
